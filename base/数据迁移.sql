...
INSERT INTO DS_BASE_UNIT (
       ID,STATUS,NAME,APPID,APPSECRET,RETURNURL,TYPE,CREATETIME,LASTTIME,MEMO)
SELECT ID,STATUS,NAME,APPID,APPSECRET,RETURNURL,TYPE,CREATETIME,LASTTIME,MEMO from DS_COMMON_UNIT;

INSERT INTO DS_BASE_BIND (
       ID,NAME,STATUS,APPID,APPSECRET,APPKEYPRIVATE,APPKEYPUBLIC,APPRETURNURL,APPTYPE,MEMO,CREATETIME,LASTTIME)
SELECT ID,NAME,STATUS,APPID,APPSECRET,APPKEYPRIVATE,APPKEYPUBLIC,APPRETURNURL,APPTYPE,MEMO,CREATETIME,LASTTIME from DS_COMMON_BIND;
...
INSERT INTO DS_BASE_USER (
       ID,BINDID,STATUS,OPENID,UNIONID,BM,SSQY,NAME,MOBILE,ACCOUNT,PASSWORD,WORKCARD,SEX,COUNTRY,PROVINCE,CITY,AVATAR,IDCARD,EMAIL,PHONE,ORGPID,ORGID,TYPE,TYPENAME,EXALIAS,EXNAME,CREATETIME,LASTTIME,CAKEY)
SELECT ID,BINDID,STATUS,OPENID,UNIONID,BM,SSQY,NAME,MOBILE,ACCOUNT,PASSWORD,WORKCARD,SEX,COUNTRY,PROVINCE,CITY,AVATAR,IDCARD,EMAIL,PHONE,ORGPID,ORGID,TYPE,TYPENAME,EXALIAS,EXNAME,CREATETIME,LASTTIME,CAKEY from DS_COMMON_USER;
...
SELECT ID,PID,SYSTEMID,NAME,ALIAS,replace(URI,'/ds/common/','/base/'),IMG,STATUS,SEQ,MEMO,RESOURCES from DS_COMMON_FUNC;
...
SELECT ID,NAME,LABEL,    0,SEQ,UPDATETIME from DS_COMMON_DICT where STATUS=1;

INSERT INTO DS_BASE_DICT (
       ID,NAME,LABEL,LEVEL,SEQ,UPDATETIME)
SELECT ID,NAME,LABEL,    1,SEQ,UPDATETIME from DS_COMMON_DICT where STATUS=0;

INSERT INTO DS_BASE_DICT_DATA (
       ID,     PID,      NAME,  LABEL,  STATUS,  SEQ,  MEMO)
SELECT a.ALIAS,b.ALIAS,a.NAME,a.LABEL,a.STATUS,a.SEQ,a.MEMO from DS_COMMON_DICT_DATA a LEFT JOIN DS_COMMON_DICT_DATA b ON b.ID=a.PID;
