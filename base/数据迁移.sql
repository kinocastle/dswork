...
SELECT ID,PID,SYSTEMID,NAME,ALIAS,URI,IMG,STATUS,SEQ,MEMO,RESOURCES from DS_COMMON_FUNC;
...
SELECT ID,PID,NAME,LABEL,STATUS,SEQ,MEMO from DS_COMMON_DICT_DATA;
